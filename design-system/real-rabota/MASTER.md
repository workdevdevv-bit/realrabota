...
**Project:** Real Rabota
**Generated:** 2026-09-09 14:37:08
**Category:** International employment service / premium lead generation
...
|------|-----|--------------|
| Primary | `#5856F8` | `--color-primary` |
| On Primary | `#FFFFFF` | `--color-on-primary` |
| Secondary | `#091633` | `--color-secondary` |
| On Secondary | `#FFFFFF` | `--color-on-secondary` |
| Accent/CTA | `#C8FF72` | `--color-accent` |
| On Accent/CTA | `#091633` | `--color-on-accent` |
| Background | `#F5F8FF` | `--color-background` |
| Foreground | `#101B39` | `--color-foreground` |
| Card | `#FFFFFF` | `--color-card` |
| Card Foreground | `#101B39` | `--color-card-foreground` |
| Muted | `#EAF1FF` | `--color-muted` |
| Muted Foreground | `#52607F` | `--color-muted-foreground` |
| Border | `#D8E2F4` | `--color-border` |
| Destructive | `#DC2626` | `--color-destructive` |
| On Destructive | `#FFFFFF` | `--color-on-destructive` |
| Ring | `#5856F8` | `--color-ring` |

**Color Notes:** User-approved Digital Confidence palette: navy for trust, blue-violet for primary action, cyan for connection routes, and lime only for high-value highlights.

### Typography

- **Heading Font:** Geist
- **Body Font:** Geist
- **Mood:** modern, clear, trustworthy, international, digital
- **Source:** bundled through the existing Next/Vinext font setup
